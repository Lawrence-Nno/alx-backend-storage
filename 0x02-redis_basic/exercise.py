...
def count_calls(method: Callable) -> Callable:
    """ Method that number of times Cache class are called """
    key = method.__qualname__

    @wraps(method)
    def wrapper(self, *args, **kwds):
        """ A wrapper function for call_calls method """
...
def call_history(method: Callable) -> Callable:
    """ Stores a particular function's history of inputs and outputs """
